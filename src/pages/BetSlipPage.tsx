        ...
        <Card key={selection.id} className="relative overflow-hidden">
          <CardHeader className="p-3 pb-0 flex flex-row justify-between items-start">
            ...
            <Button 
              ...
              onClick={() => {
                // Re-implement toggle to simulate removal
        ...
        {betCount > 0 ? (
          <>
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-bold">Bet Slip ({betCount})</h2>
              <Button 
                variant="outline" 
                size="sm" 
            ...
            <div className="fixed bottom-[72px] left-0 right-0 bg-white border-t p-4 flex flex-col gap-3">
              <div className="flex justify-between items-center">
