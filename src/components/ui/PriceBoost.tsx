    ...
    <div className="w-[320px] p-3 rounded-xl shadow border border-gray-200 bg-white space-y-3">
      ...
      <div className="flex items-center">
        ...
        >
          ...
          <g clipPath="url(#clip0_2322_15354)">
            <path
            ...
            />
            <path
              d="M14.8038 5.22168L12.0001 7.1114L9.19653 5.22168"
              stroke="#111111"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M13.6942 19.1366L15.0885 16.2906L18.2722 15.8018"
              stroke="#111111"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M19.3099 12.5925L17.076 10.3677L17.5552 7.21338"
              stroke="#111111"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
